"""
live_scores_fetcher.py ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Fetches LIVE games and pushes to BOTH live_scores.json AND parlayos html
...
def inject_into_html(live_data):
    ...
    injection = f'''
    // ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ LIVE SCORES AUTO-PUSH (generated by live_scores_fetcher.py {updated_str}) ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
    ...
    (function(){{
        ...
        function injectLiveScores(){{
                ...
                if(mount.innerHTML.includes('No live games') || mount.innerHTML.trim() === ''){{
                    mount.innerHTML = `
                      <div class="live-header">
                        ...
                        <span style="font-size:11px; opacity:0.6;">Updated ${{new Date().toLocaleTimeString()}} ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ No live games</span>
                      </div>
            ...
            mount.innerHTML = `
              <div class="live-header">
                <h2><span class="live-dot"></span>Live Scores ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ ${{games.length}} LIVE</h2>
                <span style="font-size:11px; opacity:0.6;">Updated ${{new Date(data.updated).toLocaleTimeString()}} ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Auto-pushed from live fetcher</span>
              </div>
              <div class="live-grid">
                ${{games.map(g=>`
                  <div class="live-card live">
                    <div class="live-top">
                      <div class="live-league">${{g.lg==='MLB'?'ÃƒÂ¢Ã…Â¡Ã‚Â¾':g.lg==='NFL'?'ÃƒÂ°Ã…Â¸Ã‚ÂÃ‹â€ ':'ÃƒÂ°Ã…Â¸Ã‚ÂÃ¢â€šÂ¬'}} ${{g.lg}}</div>
    ...
    // ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ END LIVE SCORES AUTO-PUSH ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
'''
    ...
    for html_path in html_files:
        try:
            ...
            text = re.sub(
                r"// ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ LIVE SCORES AUTO-PUSH.*?// ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ END LIVE SCORES AUTO-PUSH ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬\s*\n",
                "",
                text,
                flags=re.DOTALL
            )
            ...
            print(f"ÃƒÂ¢Ã…â€œÃ¢â‚¬Å“ Injected live data into {html_path.name} ({len(live_data['games'])} games)")
            
        except Exception as e:
            print(f"ÃƒÂ¢Ã…â€œÃ¢â‚¬â€ Failed to inject into {html_path.name}: {e}")
            import traceback
            traceback.print_exc()
