...
CSV_PATH = os.path.join(HERE, "nfl_picks_log.csv")
CALIBRATION_PATH = os.path.join(HERE, "nfl_calibration.json")
CONFIG_PATH = os.path.join(HERE, "sports_config.json")

MIN_FOR_CALIBRATION = 60  # NFL season shorter, 60 games is ~4 weeks   # lowered slightly but with regularization it's safer
