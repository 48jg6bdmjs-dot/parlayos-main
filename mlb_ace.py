...
# codebase — anyone with a copy of this file had a live, usable key
...
# config file yet — but the config file is now the source of truth going
...
def _load_odds_api_key():
    try:
        ...
        pass
    print("  sports_config.json not found/malformed — falling back to the "
